...
docupipe 是一个通用文档传输与处理工具，支持从多种文档源获取内容，经过可配置的处理步骤，传输到多种目标系统。设计受 KETTLE 启发，将文档及其附件作为一个原子包（Bundle），在管道中整体传输、逐步加工。
...
| [插件系统参考](reference-plugins.md) | 插件加载机制、配置、冲突检测、CLI 命令 |
